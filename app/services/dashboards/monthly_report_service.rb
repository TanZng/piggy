module Dashboards
  class MonthlyReportService < ApplicationService
    ...
    def call
      ...
      report.daily_expense = query_expense_currency_group_by_day
      report.daily_income = query_income_currency_group_by_day
      report
    end
    ...
    def query_expense_interface
      FinancialObjects::MontlyQuery.new(@user, @month, @year,
    ...
    def query_expense_currency_group_by_day
      query_expense_interface.currency_group_by_day
    end

    def query_income_currency_group_by_day
      query_income_interface.currency_group_by_day
    end
